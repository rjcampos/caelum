			...
			<article>
				...
				<section>
					...
					<p>
						...
						de seu filho <em>E. S. Pelho Filho</em>, atual <strong>CEO</strong>. O nome da empresa é inspirado no nome da família.
					</p>
					...
					<p>
						...
						Fashion, além de <strong>presidentes da União Européia, Ásia e o secretário-geral da ONU</strong>.
					</p>
				</section>
				...
				<section>
					...
					<!-- Início da lista de diferenciais -->
					<ul>
